            ...
            try:
                ...
                while True:
                    ...
                    if result >= 0:
                        ...
                        output_path = environ["RECORD_PATH"]
...
def porcupine_parsing():
    ...
    parser.add_argument('--access_key',
                        help='AccessKey obtained from Picovoice Console (https://console.picovoice.ai/)', default=environ["PICOVOICE_KEY"])
    ...
    parser.add_argument(
        '--model_path',
        help='Absolute path to the file containing model parameters.', default=environ["MODEL_PATH"])
    ...
    parser.add_argument('--audio_device_index',
                        help='Index of input audio device.', type=int, default=int(environ["AUDIO_INDEX"]))
